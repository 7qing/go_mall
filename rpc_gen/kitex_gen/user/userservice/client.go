...
func (p *kUserServiceClient) GetEmail(ctx context.Context, Req *user.DeleteReq, callOptions ...callopt.Option) (r *user.GetEmailResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetEmail(ctx, Req)
}

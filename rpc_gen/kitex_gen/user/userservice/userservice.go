...
func getEmailHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(user.DeleteReq)
		...
		resp, err := handler.(user.UserService).GetEmail(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetEmailArgs:
		success, err := handler.(user.UserService).GetEmail(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetEmailResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetEmailArgs() interface{} {
	return &GetEmailArgs{}
}

func newGetEmailResult() interface{} {
...
func (p *GetEmailArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(user.DeleteReq)
	}
	return p.Req.FastRead(buf, _type, number)
...
func (p *GetEmailArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *GetEmailArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *GetEmailArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetEmailArgs) Unmarshal(in []byte) error {
	msg := new(user.DeleteReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
...
var GetEmailArgs_Req_DEFAULT *user.DeleteReq

func (p *GetEmailArgs) GetReq() *user.DeleteReq {
	if !p.IsSetReq() {
		return GetEmailArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetEmailArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetEmailArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetEmailResult struct {
	Success *user.GetEmailResp
}

var GetEmailResult_Success_DEFAULT *user.GetEmailResp

func (p *GetEmailResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.GetEmailResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *GetEmailResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *GetEmailResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *GetEmailResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetEmailResult) Unmarshal(in []byte) error {
	msg := new(user.GetEmailResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetEmailResult) GetSuccess() *user.GetEmailResp {
	if !p.IsSetSuccess() {
		return GetEmailResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetEmailResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.GetEmailResp)
}

func (p *GetEmailResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetEmailResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetEmail(ctx context.Context, Req *user.DeleteReq) (r *user.GetEmailResp, err error) {
	var _args GetEmailArgs
	_args.Req = Req
	var _result GetEmailResult
	if err = p.c.Call(ctx, "GetEmail", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

...
type VerifyTokenReq struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // 要验证的身份令牌
}
...
type DeliveryResp struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // 返回的身份令牌
}
...
type VerifyResp struct {
	...
	Res    bool   `protobuf:"varint,1,opt,name=res,proto3" json:"res,omitempty"`                     // 校验结果，true 表示合法，false 表示无效
	UserId int32  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // 返回用户ID
	Role   string `protobuf:"bytes,3,opt,name=role,proto3" json:"role,omitempty"`                    // 用户角色（用于权限认证）
}
...
type RenewTokenReq struct {
	...
	RefreshToken string `protobuf:"bytes,1,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"` // 用于续期的 refresh token
}
...
var file_auth_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x4b, 0x0a, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x34, 0x0a, 0x0d, 0x52, 0x65, 0x6e,
	...
	0xcb, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x3c, 0x0a, 0x0f, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x79, 0x52,
	0x50, 0x43, 0x12, 0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x44,
	0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x30, 0x5a,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x37, 0x71, 0x69, 0x6e,
	0x67, 0x2f, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e,
...
var file_auth_proto_depIdxs = []int32{
	...
	2, // 5: auth.AuthService.RenewTokenByRPC:output_type -> auth.DeliveryResp
...
type AuthService interface {
	...
	RenewTokenByRPC(ctx context.Context, req *RenewTokenReq) (res *DeliveryResp, err error)
}

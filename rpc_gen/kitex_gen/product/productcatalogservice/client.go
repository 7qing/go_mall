...
func (p *kProductCatalogServiceClient) DelProduct(ctx context.Context, Req *product.DelProductReq, callOptions ...callopt.Option) (r *product.DelProductResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)

...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"DelProduct": kitex.NewMethodInfo(
		delProductHandler,
		newDelProductArgs,
		newDelProductResult,
		false,
...
func delProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(product.DelProductReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(product.ProductCatalogService).DelProduct(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DelProductArgs:
		success, err := handler.(product.ProductCatalogService).DelProduct(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*DelProductResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newDelProductArgs() interface{} {
	return &DelProductArgs{}
}

func newDelProductResult() interface{} {
	return &DelProductResult{}
}

type DelProductArgs struct {
	Req *product.DelProductReq
}

func (p *DelProductArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(product.DelProductReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *DelProductArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *DelProductArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *DelProductArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *DelProductArgs) Unmarshal(in []byte) error {
	msg := new(product.DelProductReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var DelProductArgs_Req_DEFAULT *product.DelProductReq

func (p *DelProductArgs) GetReq() *product.DelProductReq {
	if !p.IsSetReq() {
		return DelProductArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *DelProductArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DelProductArgs) GetFirstArgument() interface{} {
	return p.Req
}

type DelProductResult struct {
	Success *product.DelProductResp
}

var DelProductResult_Success_DEFAULT *product.DelProductResp

func (p *DelProductResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(product.DelProductResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *DelProductResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *DelProductResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *DelProductResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *DelProductResult) Unmarshal(in []byte) error {
	msg := new(product.DelProductResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *DelProductResult) GetSuccess() *product.DelProductResp {
	if !p.IsSetSuccess() {
		return DelProductResult_Success_DEFAULT
	}
	return p.Success
}

func (p *DelProductResult) SetSuccess(x interface{}) {
	p.Success = x.(*product.DelProductResp)
}

func (p *DelProductResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DelProductResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) DelProduct(ctx context.Context, Req *product.DelProductReq) (r *product.DelProductResp, err error) {
	var _args DelProductArgs
	_args.Req = Req
	var _result DelProductResult

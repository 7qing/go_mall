...
type RPCClient interface {
	...
	DelProduct(ctx context.Context, Req *product.DelProductReq, callOptions ...callopt.Option) (r *product.DelProductResp, err error)
}
...
func (c *clientImpl) DelProduct(ctx context.Context, Req *product.DelProductReq, callOptions ...callopt.Option) (r *product.DelProductResp, err error) {
	return c.kitexClient.DelProduct(ctx, Req, callOptions...)
}

...
type RPCClient interface {
	...
	GetEmail(ctx context.Context, Req *user.DeleteReq, callOptions ...callopt.Option) (r *user.GetEmailResp, err error)
}
...
func (c *clientImpl) GetEmail(ctx context.Context, Req *user.DeleteReq, callOptions ...callopt.Option) (r *user.GetEmailResp, err error) {
	return c.kitexClient.GetEmail(ctx, Req, callOptions...)
}
